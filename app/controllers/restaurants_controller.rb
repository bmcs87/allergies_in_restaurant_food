class RestaurantsController < ApplicationController
  def index
    ...
    @restaurants = @q.result(:distinct => true).includes(:cuisines, :allergens, :dishes).page(params[:page]).per(10)
  ...
  def create
    ...
    @restaurant.entrees_id = params[:entrees_id]
    @restaurant.allergens_id = params[:allergens_id]
